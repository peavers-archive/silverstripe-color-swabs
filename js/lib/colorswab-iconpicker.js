...
(function (a) {
    ...
    var c = function (d, e) {
        ...
        if (this.container.addClass("colorpicker-container").is(".dropdown-menu")) {
            this.options.placement = "inline";
        }
        this.input = this.element.is("input") ? this.element.addClass("colorpicker-input") : false;
        if (this.input === false) {
            this.input = this.container.find(this.options.input);
        }
        this.component = this.container.find(this.options.component).addClass("colorpicker-component");
        ...
        this._trigger("colorpickerCreated");
    };
    c._idCounter = 0;
    c.defaultOptions = {
        title: false,
        ...
        iconClassPrefix: "color-",
        input: "input",
        component: ".input-group-addon",
        container: false,
        templates: {
            popover: '<div class="colorpicker-popover popover"><div class="arrow"></div>' + '<div class="popover-title"></div><div class="popover-content"></div></div>',
            footer: '<div class="popover-footer"></div>',
            buttons: '<button class="colorpicker-btn colorpicker-btn-cancel btn btn-default btn-sm">Cancel</button>' + ' <button class="colorpicker-btn colorpicker-btn-accept btn btn-primary btn-sm">Accept</button>',
            search: '<input type="search" class="form-control colorpicker-search" placeholder="Type to filter" />',
            colorpicker: '<div class="colorpicker"><div class="colorpicker-items"></div></div>',
            colorpickerItem: '<div class="colorpicker-item"><i></i></div>'
        }
    };
    c.batch = function (b, c) {
        var d = Array.prototype.slice.call(arguments, 2);
        return a(b).each(function () {
            var b = a(this).data("colorpicker");
            if (!!b) {
                b[c].apply(b, d);
            }
        });
    ...
    c.prototype = {
        ...
        _createColorpicker: function () {
            var b = this;
            this.colorpicker = a(this.options.templates.colorpicker);
            var c = function (c) {
                var d = a(this);
                if (d.is("." + b.options.iconBaseClass)) {
                    d = d.parent();
                }
                b._trigger("colorpickerSelect", {
                    colorpickerItem: d,
                    colorpickerValue: b.colorpickerValue
                });
                if (b.options.mustAccept === false) {
                    b.update(d.data("colorpickerValue"));
                    b._trigger("colorpickerSelected", {
                        colorpickerItem: this,
                        colorpickerValue: b.colorpickerValue
                    });
                } else {
                    b.update(d.data("colorpickerValue"), true);
                }
            ...
            for (var d in this.options.icons) {
                var e = a(this.options.templates.colorpickerItem);
                e.find("i").addClass(b.options.iconBaseClass + " " + this.options.iconClassPrefix + this.options.icons[d]);
                e.data("colorpickerValue", this.options.icons[d]).on("click.colorpicker", c);
                this.colorpicker.find(".colorpicker-items").append(e.attr("title", "." + this.getValue(this.options.icons[d])));
            }
            this.popover.find(".popover-content").append(this.colorpicker);
            return this.colorpicker;
        },
        _isEventInsideColorpicker: function (b) {
            var c = a(b.target);
        ...
        _bindElementEvents: function () {
            ...
            this.getAcceptButton().on("click.colorpicker", function () {
                var a = c.colorpicker.find(".colorpicker-selected").get(0);
                c.update(c.colorpickerValue);
                c._trigger("colorpickerSelected", {
                    colorpickerItem: a,
                    colorpickerValue: c.colorpickerValue
                });
                if (!c.isInline()) {
                    c.hide();
                }
            });
            this.getCancelButton().on("click.colorpicker", function () {
                if (!c.isInline()) {
                    c.hide();
                }
            });
            this.element.on("focus.colorpicker", function (a) {
                c.show();
                a.stopPropagation();
            });
            if (this.hasComponent()) {
                this.component.on("click.colorpicker", function () {
                    c.toggle();
                });
            }
            if (this.hasInput()) {
                this.input.on("keyup.colorpicker", function (a) {
        ...
        _bindWindowEvents: function () {
            ...
            var c = this;
            var d = ".colorpicker.inst" + this._id;
            a(window).on("resize.colorpicker" + d + " orientationchange.colorpicker" + d, function (a) {
            ...
            if (!c.isInline()) {
                b.on("mouseup" + d, function (a) {
                    if (!c._isEventInsideColorpicker(a) && !c.isInline()) {
                        c.hide();
                    }
                    a.stopPropagation();
                    a.preventDefault();
        ...
        _unbindElementEvents: function () {
            ...
            if (this.hasContainer()) {
                this.container.off(".colorpicker");
            }
        },
        _unbindWindowEvents: function () {
            a(window).off(".colorpicker.inst" + this._id);
            a(window.document).off(".colorpicker.inst" + this._id);
        },
        ...
        _updateComponents: function () {
            this.colorpicker.find(".colorpicker-item.colorpicker-selected").removeClass("colorpicker-selected " + this.options.selectedCustomClass);
            this.colorpicker.find("." + this.options.iconBaseClass + "." + this.options.iconClassPrefix + this.colorpickerValue).parent().addClass("colorpicker-selected " + this.options.selectedCustomClass);
            if (this.hasComponent()) {
        ...
        setValue: function (a) {
            ...
            if (b !== false) {
                this.colorpickerValue = b;
                this._trigger("colorpickerSetValue", {
                    colorpickerValue: b
                });
                return this.colorpickerValue;
            } else {
                this._trigger("colorpickerInvalid", {
                    colorpickerValue: a
                });
                return false;
            }
        ...
        getValue: function (a) {
            return this.options.iconClassPrefix + (a ? a : this.colorpickerValue);
        },
        ...
        setSourceValue: function (a) {
            ...
            if (a !== false && a !== "") {
                if (this.hasInput()) {
                    ...
                    this.element.data("colorpickerValue", this.getValue());
                }
                this._trigger("colorpickerSetSourceValue", {
                    colorpickerValue: a
                });
            }
            return a;
        ...
        getSourceValue: function (a) {
            ...
            if (this.hasInput()) {
                ...
                b = this.element.data("colorpickerValue");
            }
        ...
        getAcceptButton: function () {
            return this.popover.find(".colorpicker-btn-accept");
        },
        getCancelButton: function () {
            return this.popover.find(".colorpicker-btn-cancel");
        },
        getSearchInput: function () {
            return this.popover.find(".colorpicker-search");
        },
        filter: function (c) {
            if (b.isEmpty(c)) {
                this.colorpicker.find(".colorpicker-item").show();
                return a(false);
            } else {
                var d = [];
                this.colorpicker.find(".colorpicker-item").each(function () {
                    var b = a(this);
        ...
        show: function () {
            ...
            a.colorpicker.batch(a(".colorpicker-popover.in:not(.inline)").not(this.popover), "hide");
            this._trigger("colorpickerShow");
            this.updatePlacement();
            this.popover.addClass("in");
            setTimeout(a.proxy(function () {
                this.popover.css("display", this.isInline() ? "" : "block");
                this._trigger("colorpickerShown");
        ...
        hide: function () {
            ...
            this._trigger("colorpickerHide");
            this.popover.removeClass("in");
            setTimeout(a.proxy(function () {
                this.popover.css("display", "none");
                this.getSearchInput().val("");
                this.filter("");
                this._trigger("colorpickerHidden");
            }, this), this.options.animation ? 300 : 1);
        },
        toggle: function () {
        ...
        update: function (a, b) {
            a = a ? a : this.getSourceValue(this.colorpickerValue);
            this._trigger("colorpickerUpdate");
            if (b === true) {
                a = this.setValue(a);
            } else {
        ...
        destroy: function () {
            ...
            this.element.removeData("colorpicker").removeData("colorpickerValue").removeClass("colorpicker-element");
            this._unbindElementEvents();
            this._unbindWindowEvents();
            a(this.popover).remove();
            this._trigger("colorpickerDestroyed");
        },
        disable: function () {
            if (this.hasInput()) {
    ...
    a.fn.colorpicker = function (b) {
        return this.each(function () {
            var d = a(this);
            if (!d.data("colorpicker")) {
                d.data("colorpicker", new c(this, typeof b === "object" ? b : {}));
            }
        });
    };
    c.defaultOptions.icons = colorSwabs;
});
